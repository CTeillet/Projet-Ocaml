...
module Dom : sig
  ...
  *)
  ...
  module Events : sig
    (** JS events handlers are elements properties in JS that can be modified to
        catch corresponding events. Calling one of those function sets the
        given function as event handler, that will be called when the event
        raises.
    *)
